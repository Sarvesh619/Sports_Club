...
<?php
  ...
  echo "<center><h4><u>List Of All Booked Plan</u></h4></center><br>";
  echo "<center><table class='table'>
    <tr>
      <th width=10>S.No</th>
      <th width=100>User Name</th>
      <th width=100>Sports Name</th>
      <th width=100>Coach Name</th>
      <th width=100>Plan Type</th>
      <th width=900>No Of Days</th>
      <th width=100>Payed Price</th>
  ...
  while($row = mysqli_fetch_assoc($query_run)){
    ...
    echo "
      <tr width=100>
        ...
        <td><a href='deleteBooked.php?bid=$id' onclick='return deleteconfirmation()'>Delete</a></td>
      </tr>
    ";
  }
  echo "</table></center>";
