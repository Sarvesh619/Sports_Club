...
<?php
        ...
        if(isset($_POST['addplan'])){
            ...
            $price=$_POST['price'];
            $day=$_POST['day'];
            $query3="select * from plan where (sid= '$sport' AND type='$type' AND price='$price' AND day='$day')";
            $query_run3 = mysqli_query($connection,$query3);
            if(mysqli_num_rows($query_run3)>0){
              echo "<script type='text/javascript'>
              alert('This plan is already Available');
              window.location.href = 'Addplan.php';  
              </script>";
                }
                else{
            $query = "insert into plan values(null,'$_POST[sport]','$_POST[type]','$_POST[price]','$_POST[day]')";
      ...
      <form action=" " method="post">
        <div class="user-details">
          ...
          <div class="input-box">
            ...
            <input type="number" class="form-control" name="day" placeholder="No Of Days"  min="1" required>
          </div>
          <div class="input-box">
            <span class="details">Price</span>
            <input type="text" placeholder="Enter Price" name="price" pattern="[0-9]+" title="please enter number only" required>
          </div><br>
