...
$sql1 ="SELECT * FROM book where bid='" . $_GET['fee_payment_id'] . "'";
...
<b>Date :</b> <?php echo date("d-m-Y",strtotime($rs1['bookdate'])); ?><strong style="color: #333; font-size: 26px;">
<br>
                                	<!--₹<?php echo $rs1['price']; ?></strong> Paid</td>-->
                                <td align="right" width="50%" style="padding: 20px;"><b>Name - </b> <?php echo $rs1['user']; ?><br><b>Sport Name-</b> <?php echo $rs1['sname']; ?><br>
                                	<b>Coach Name -</b> <?php echo $rs1['cname']; ?> <br>
                                	<b>Type -</b> <?php echo $rs1['type']; ?><br>
                                </td>
                            </tr>
                        </tbody>
                    </table>
                                    ...
                                    <table cellspacing="0" style="border-collapse: collapse; margin-bottom: 40px;width: 500px;">
                                        <tbody>
                                            <tr>
                                                ...
                                                <td align="right" style="padding: 5px 0;">₹<?php echo $rs1['price']; ?></td>
                                            </tr>
                                            <tr>
                                            ...
                                            <tr>
                                                ...
                                                <td align="right" style="border-bottom: 2px solid #000; border-top: 2px solid #000; font-weight: bold; padding: 5px 0;">₹<?php echo $rs1['price'] - $rs1['price']; ?></td>
                                            </tr>
                                        </tbody>
                                    </table>
