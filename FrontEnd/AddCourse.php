...
<?php
        ...
        if(isset($_POST['addcourse'])){
                ...
                $days=$_POST['days'];
                $eid=$_POST['eid'];
                $query5="select * from course where (cname='$cname' AND des='$des' AND fee='$fee' AND days='$days' AND eid='$eid' )";
                $query_run5 = mysqli_query($connection,$query5);
                if(mysqli_num_rows($query_run5)>0){
                    echo "<script type='text/javascript'>
                    alert('This Course is already Available');
                    window.location.href = 'AddCourse.php';  
                    </script>";
                }
                else{
            $query = "insert into course values(null,'$_POST[eid]','$_POST[cname]','$_POST[des]','$_POST[fee]','$_POST[days]')";
      ...
      <form action=" " method="post">
        <div class="user-details">
          ...
          <div class="input-box">
            ...
            <input type="textarea" placeholder="Enter Description" name="des" required>
          </div><br>
          <div class="input-box">
            <span class="details">Enter Fee</span>
            <input type="number" placeholder="Enter Fee" name="fee" min="0" required>
          </div><br>
          <div class="input-box">
  <span class="details">Enter Duration (days)</span>
  <input type="number" placeholder="Enter Duration" name="days" min="0" required>
</div><br>
<div class="input-box">
            <span class="details">Select Employee</span>
