...
$sql1 ="SELECT * FROM enrollc where eid='" . $_GET['fee_payment_id'] . "'";
$qsql1 = mysqli_query($connection,$sql1);
$rs1 = mysqli_fetch_array($qsql1);
$sql2="SELECT * FROM course where cid='".$rs1['cid'] ."'";
            ...
            <tr>
                ...
                <td bgcolor="#FFFFFF" style="border: 1px solid #000; clear: both; display: block; margin: 0 auto; max-width: 600px; padding: 0;">
                    <table width="100%" style="background: #f9f9f9; border-bottom: 1px solid #eee; border-collapse: collapse; color: #999;">
                        <tbody>
                            <tr>
                                <td width="30%" style="padding: 20px;"><img src="../images/creditcard.png" style="height: 60px;width: 200px;"></img></td>
                                <td align="right" width="70%" style="padding: 20px;"><?php echo "Pune Youth Club in Pune 244, Bhandarkar Rd Deccan Gymkhana Pune - 411004"; ?>,<br><?php echo "sarvesh@gmail.com" ?>,<br> <?php echo "9422267122" ?></td>
                            </tr>
                        </tbody>
                    </table>
                </td>
...
<b>Date :</b> <?php echo date("d-m-Y",strtotime($rs1['enrolldate'])); ?><strong style="color: #333; font-size: 26px;">
<br>
                                	<!--₹<?php echo $rs1['price']; ?></strong> Paid</td>-->
                                <td align="right" width="50%" style="padding: 20px;"><b>Name - </b> <?php echo $rs1['user']; ?><br><b>Course Name-</b> <?php echo $rs2['cname']; ?><br>
                                	<b>Description -</b> <?php echo $rs2['des']; ?> <br>
                                	<b>Course Duration -</b> <?php echo $rs2['days']; ?> Days<br>
                                </td>
                            </tr>
                        </tbody>
                    </table>
                                    ...
                                    <table cellspacing="0" style="border-collapse: collapse; margin-bottom: 40px;width: 500px;">
                                        <tbody>
                                            <tr>
                                                ...
                                                <td align="right" style="padding: 5px 0;">₹<?php echo $rs2['fee']; ?></td>
                                            </tr>
                                            <tr>
                                                <td style="padding: 5px 0;">Paid Amount</td>
                                                <td align="right" style="padding: 5px 0;">₹<?php echo $rs1['fee']; ?></td>
                                            </tr>
                                            <tr>
                                                <td style="border-bottom: 2px solid #000; border-top: 2px solid #000; font-weight: bold; padding: 5px 0;">Balance Amount</td>
                                                <td align="right" style="border-bottom: 2px solid #000; border-top: 2px solid #000; font-weight: bold; padding: 5px 0;">₹<?php echo $rs2['fee'] - $rs1['fee']; ?></td>
                                            </tr>
                                        </tbody>
                                    </table>
