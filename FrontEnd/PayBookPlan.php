...
$query3="select * from book where (user='$uname' AND sname= '$sname' AND cname='$cname' AND type='$type' AND  price='$price')";
...
$query2 = "insert into book values(null,'$_SESSION[uname]','$_GET[sname]','$_GET[cname]','$_GET[type]','$_GET[price]','$_GET[day]','$dt','$serializepmt')";
			...
			<div class="col-md-10 col-sm-offset-1 book-appointment" >
				...
				<form action="" method="post" name="frm" onsubmit="return validateform()">
					<div class="col-md-6 gaps">
						...
						<input type="number" style="background: rgb(255 219 219);" readonly name="balance"  value="<?php echo $_GET['price']; ?>" />
					</div>
