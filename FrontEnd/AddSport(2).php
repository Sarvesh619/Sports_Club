...
<?php
        ...
        $query2="select sname from sports";
    $query_run2 = mysqli_query($connection,$query2);
    while($row2 = mysqli_fetch_assoc($query_run2))
      { $sname=$_POST['sname'];
        if($sname==$row2['sname']){
          echo "<script type='text/javascript'>
          alert('Duplicate Sports are not allowed....');
          window.location.href = 'AddSport(2).php';  
        </script>";
        }
      }
    $query = "insert into sports values(null,'$_POST[sname]','$_POST[cname]','$_POST[img]')";
  	$query_run = mysqli_query($connection,$query);
    if($query_run){
      echo "<script type='text/javascript'>
      	alert('SPORT ADDED SUCCESFULLY');
      ...
      <form action=" " method="post" name="frm" onsubmit="return validateform()">
        <div class="user-details">
          ...
          <div class="input-box">
            ...
            <input type="text" placeholder="Enter Sport Name" name="sname" required>
          </div>
          <div class="input-box">
            <span class="details">Select Coach</span>
            ...
            while ($row = mysqli_fetch_array(
                ...
                ?>
                    <option value="<?php echo $row['ename'];
                    ?>">
                               <?php echo $row['ename'];?>
                    </option>
                <?php
          ...
          <input type="submit"  name="addsport"  value="Add Sport">
        </div>
          <div class="input-box">
            <span class="details">Sport Image</span>
            <input type="file" placeholder="Sport image" name="img" required>
          </div>
