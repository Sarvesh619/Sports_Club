...
<?php
  ...
  echo "<center><table class='table' border=1 width=1000>
    <tr>
      ...
      <th width=100>Match Description</th>
  ...
  while($row = mysqli_fetch_assoc($query_run)){
    ...
    echo "
      <tr width=100>
        ...
        <td><a class='button' href='deletetourR.php?toid=$id' onclick='return deleteconfirmation()'>Delete</a></td>
      </tr>
    ";
  }
}
