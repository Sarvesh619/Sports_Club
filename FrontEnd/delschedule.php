...
<?php
  ...
  $query = "select * from sch";
  $query_run = mysqli_query($connection,$query);
  $sn = 0;
  echo "<center><h4><u>List Of Schedule</u></h4></center><br>";
  echo "<center><table class='table' border=1 width=1000>
    <tr>
      <th width=100>S.No</th>
      <th width=100>Sport ID</th>
  ...
  while($row = mysqli_fetch_assoc($query_run)){
    ...
    echo "
      <tr width=100>
        ...
        <td><a class= 'button' href='deletesch.php?scid=$id'onclick='return deleteconfirmation()'>Delete</a></td>
      </tr>
    ";
  }
}
