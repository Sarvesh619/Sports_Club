  ...
  while($row = mysqli_fetch_assoc($query_run)){
    ...
    echo "
      <tr width=100>
        ...
        <td><a class='button' href='deletesport.php?sid=$id' onclick='return deleteconfirmation()'>Delete</a></td>
      </tr>
    ";
  }
  echo "</table></center>";
