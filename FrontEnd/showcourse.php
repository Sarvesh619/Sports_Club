  ...
  while($row = mysqli_fetch_assoc($query_run)){
    ...
    echo "
      <tr width=100>
        ...
        <td><a class='button' href='deletecourse.php?cid=$id' onclick='return deleteconfirmation()'>Delete</a></td>
      </tr>
    ";
  }
}
